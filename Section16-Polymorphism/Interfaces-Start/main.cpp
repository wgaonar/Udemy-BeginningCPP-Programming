...
int main() {
  ...
  std::cout << "\n === Insertion operator is working with static bound ==== " << std::endl;
  Account a;
  std::cout << a<< std::endl;
  ...
  std::cout << "\n === Base class is bounded dynamically ==== " << std::endl;
  Account *p1 = new Account();
  std::cout << *p1<< std::endl;

  std::cout << "\n === Polymorphism does not working with insertion operator :( ==== " << std::endl;
