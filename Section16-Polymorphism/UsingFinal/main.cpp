...
{
public:
  virtual void say_hello()  const override final // Prevents override say_hello() method
  {       
...
int main() 
{
  ...
  Base *p3 = new Derived();           // Base::say_hello()?, No It points to a Derived::say_hello() IMPORTANT !!!
  p3->say_hello();
